...
export default function App({ file, href, children}) {
  ...
  useEffect(() => {
    if (router.isReady) {
      setFootprint(localStorage.getItem('schoolfootprint'));
            ...
            <div className="card roundedBox no-border bg-white p-4 card-drop cardSpacing">
              ...
              <Row>
                <Col>
                  ...
                  {editingdata.emissionsCarbon}<Link href="/school-calculator"><a className="modal-btn bold">{editingdata.emissionsLink}</a></Link>
                </Col>
              </Row>
              <hr/>
              <Row>
