        ...
        <Container className="bg-green py-5 my-5">
          <Row className="justify-content-center d-flex mb-3 pt-lg-5">
            <Col className="col-xl-10 ">
              <h1 className="h2 text-orange text-center">Welcome Back, {user ? user.name : 'stranger'}</h1>
            </Col>
          </Row>
                    ...
                    <TabPanel>
                      ...
                      <Tabs>
                        <TabList className="tabRow mb-0">
                          <Tab className="link bold text-orange">Dashboard</Tab>
                          <Tab className="link bold text-orange">ForestCast<sup>™</sup></Tab>
                        </TabList>
