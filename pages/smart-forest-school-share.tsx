  ...
  return (
    <div className="bg-school">
      ...
      <Head>
        ...
        <meta name="twitter:title" content="School Net-Zero Calculator" />
        <meta name="twitter:description" content="Calculate how many acres your school must invest in to reach a net-zero emissions target" />
        <meta name="twitter:image" content={sharingPrefix + '/logo-share-preview-twitter.png'} />
        <meta name="twitter:card" content="summary_large_image" />

        <meta property='og:title' content="School Net-Zero Calculator"/>
        <meta property='og:description' content="Calculate how many acres your school must invest in to reach a net-zero emissions target"/>
