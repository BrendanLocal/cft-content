        ...
        <Container className="bg-green py-5">
          <Row className="justify-content-center d-flex pt-5 mt-5">
            <Col className="col-10 col-md-7 col-lg-10 ">
              <h1 className="h2 text-orange text-center bold py-3">Welcome to our Customer Portal!</h1>
            </Col>
          </Row>
            ...
            <Col className="col-11 col-md-8 col-lg-5 col-xl-4 p-4">
              <div className="justify-content-center text-center roundedBox no-border card-drop p-5 pb-4 bg-white">
                ...
                <form onSubmit={onSubmit}>
                  ...
                  <br/>
                  <Button className="btn-green signin-btn mb-3 w-100" type="submit">Sign in</Button>
                  <br/>
                  <Link href="/contact" className="text-center">
                    <a className="text-orange text-small text-center textButton modal-btn bold" >Contact us to become a stakeholder</a>
                  </Link>
                  <br/>
