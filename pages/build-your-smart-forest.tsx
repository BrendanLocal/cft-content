          ...
          <Fade bottom>
            <Row className="text-center justify-content-center py-3 px-xl-3 px-lg-2 px-5 mt-5">
              <Col className="col-12 col-md-9 col-lg-7">
                ...
                <img src="../../ECOSYSTEMBENEFITS-Corp.jpg" alt="information on corporate smart forests"/>
              </Col>
            </Row>
          ...
          <Fade bottom>
            <Row className="text-center justify-content-center py-3 px-5 mt-5">
              <Col className="col-12 col-md-9 col-lg-7">
                ...
                <img src="../../ECOSYSTEMBENEFITS-School.jpg" alt="information on school smart forests"/>
          ...
          <Fade bottom>
            <Row className="text-center justify-content-center py-3 px-4 mt-5">
              <Col className="col-12 col-md-9 col-lg-7">
                ...
                <img src="../../ECOSYSTEMBENEFITS-Legacy.jpg" alt="information on legacy smart forests"/>
          ...
          <Fade bottom>
            <Row className="text-center justify-content-center py-3 px-5 mt-5">
              <Col className="col-12 col-md-9 col-lg-7">
                ...
                <img src="../../ECOSYSTEMBENEFITS-Community.jpg" alt="information on communal smart forests"/>
