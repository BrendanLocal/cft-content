          ...
          <Row className="justify-content-center">
            ...
            <Col className="col-11 col-lg-8 col-xl-7">
              ...
              <h4 className="bold">INTRODUCTION</h4>
                ...
                <p className="mb-3 smallCaps bold">
                ...
                <p className="mb-3">
                If you are concerned about our response or would like to correct the information provided, you may contact our <span className="bold">John Jussup</span> at <a href="mailto:legal@canadasforesttrust.ca" className="text-orange">legal@canadasforesttrust.ca</a>.
                </p>
