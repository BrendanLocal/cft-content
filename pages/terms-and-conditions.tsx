            ...
            <Col className="col-11 col-lg-8 col-xl-7">
              <div className="bg-brown roundedBox innerShadow text-white p-4 p-md-5">
                ...
                <Row className="mb-3">
                  ...
                  <Col className="col-9">
                    <p>using any robot, spider, or other automatic device, process, or means to access the Website for any purpose, including monitoring or copying any of the material on the Website;</p>
                  </Col>
                </Row>
                ...
                <Row className="mb-3">
                  ...
                  <Col className="col-9">
                    <p>introducing any viruses, trojan horses, worms, logic bombs, or other material that is malicious or technologically harmful;</p>
                  </Col>
                </Row>
                ...
                <Row className="mb-3">
                  ...
                  <Col className="col-9">
                    <p>attacking the Website via a denial-of-service attack, distributed denial-of-service attack, flooding, mailbombing, or crashing; and</p>
                  </Col>
                </Row>
                ...
                <Row className="mb-3">
                  ...
                  <Col className="col-9">
                    <p>otherwise attempting to interfere with the proper working of the Website.</p>
                  </Col>
                </Row>
                ...
                <Row className="mb-3">
                  ...
                  <Col className="col-9">
                    <p>Take appropriate legal action, including, without limitation, referral to law enforcement or regulatory authority, or notifying the harmed party of any illegal or unauthorized use of the Website. Without limiting the foregoing, we have the right to fully cooperate with any law enforcement authorities or court order requesting or directing us to disclose the identity or other information of anyone accessing or requesting any materials on or through the Website.</p>
                  </Col>
                </Row>
                ...
                <Row className="mb-3">
                  ...
                  <Col className="col-9">
                    <p>Terminate or suspend your access to all or part of the Website for any or no reason, including, without limitation, any violation of these Terms.</p>
                  </Col>
                </Row>

                <p className="mb-3">YOU WAIVE AND HOLD HARMLESS THE CFT AND ITS PARENT, SUBSIDIARIES, AFFILIATES, AND THEIR RESPECTIVE DIRECTORS, OFFICERS, EMPLOYEES, AGENTS, SERVICE PROVIDERS, CONTRACTORS, LICENSORS, LICENSEES, SUPPLIERS, AND SUCCESSORS FROM ANY AND ALL CLAIMS RESULTING FROM ANY ACTION TAKEN BY CFT AND ANY OF THE FOREGOING PARTIES RELATING TO ANY, INVESTIGATIONS BY EITHER CFT OR SUCH PARTIES OR BY LAW ENFORCEMENT AUTHORITIES.</p>

                <p className="mb-3">We have no obligation, nor any responsibility to any party to monitor the Website or its use. </p>
                ...
                <p className="mb-3">The content on our Website is provided for general information purposes only. It is not intended to amount to advice on which you should rely. You must obtain more specific or professional advice before taking, or refraining from, any action or inaction on the basis of the content on our site. </p>

                <p className="mb-3">Although we make reasonable efforts to update the information on our Website, we make no representations, warranties, or guarantees, whether express or implied, that the content on our Website is accurate, complete, or up to date. Your use of the Website is at your own risk and CFT has no responsibility or liability whatsoever for your use of this Website.</p>

                <p className="mb-3">This Website may include content provided by third parties, including from other users and third-party licensors. All statements and/or opinions expressed in any such third-party content, other than the content provided by CFT, are solely the opinions and the responsibility of the person or entity providing those materials. Such materials do not necessarily reflect the opinion of CFT. CFT has no responsibility or liability whatsoever to you, or any third party, for the content or accuracy of any third-party materials.</p>
                ...
                <p className="mb-3">By submitting your personal information and using our Website, you consent to the collection, use, reproduction, hosting, transmission, and disclosure of any such user content submissions in compliance with our <a href="/privacy" className="text-orange">Privacy Policy</a>, as we deem necessary for use of the Website.</p>

                <p className="mb-3">By using this Website you are consenting to the use of cookies which allow a server to recall previous requests or registration and/or IP addresses to analyze website use patterns. You can set your browser to notify you before you receive a cookie, giving you the chance to decide whether to accept it. You can also set your browser to turn off cookies. If you do, however, some areas of the Website may not function adequately. For more information on this automated information gathering practices, see our <a href="/privacy" className="text-orange">Privacy Policy</a>.     </p>
                ...
                <Row className="mt-5">
                  ...
                  <Col className="col-10">
                    <h4 className="bold">Third-Party Websites</h4>
                  </Col>
                </Row>

                <p className="mb-3">For your convenience, this Website may provide links or pointers to third-party sites. We make no representations about any other websites that may be accessed from this Website. If you choose to access any such sites, you do so at your own risk. We have no control over the contents of any such third-party sites and accept no responsibility for such sites or for any loss or damage that may arise from your use of them. You are subject to any terms and conditions of such third-party sites.</p>

                <p className="mb-3">Such links to third-party sites from the Website may include links to certain social media features that enable you to link or transmit on your own or using certain third-party websites, certain content from this Website. You may only use these features when they are provided by us and solely with respect to the content identified.</p>
                    
                <p className="mb-3">You may link to our homepage, provided you do so in a way that is fair and legal and does not damage our reputation or take advantage of it. You must not establish a link in such a way as to suggest any form of association, approval, or endorsement on our part where none exists. Our Website must not be framed on any other site, nor may you create a link to any part of our Website other than the homepage. We reserve the right to withdraw linking permission without notice. The website in which you are linking must comply in all respects with the provisions regarding Conditions of Use and Site Content Standards in these Terms. You agree to cooperate with us in causing any unauthorized framing or linking to immediately stop.</p>
                ...
                <Row className="mt-5">
                  ...
                  <Col className="col-10">
                    <h4 className="bold">Geographic Restrictions</h4>
                  </Col>
                </Row>

                <p className="mb-3">The owner of the Website is based in Ontario in Canada. We provide this Website for use only by persons located in Canada. This Website is not intended for use in any jurisdiction where its use is not permitted. If you access the Website from outside Canada, you do so at your own risk and you are responsible for compliance with local laws of your jurisdiction.</p>
                ...
                <Row className="mt-5">
                  ...
                  <Col className="col-10">
                    <h4 className="bold">Indemnification</h4>
                  </Col>
                </Row>

                <p className="mb-3">To the maximum extent permitted by applicable law, you agree to defend, indemnify, and hold harmless CFT, its parent, subsidiaries, affiliates, and their respective directors, officers, employees, agents, service providers, contractors, licensors, suppliers, successors, and assigns from and against any claims, liabilities, damages, judgments, awards, losses, costs, expenses, or fees (including reasonable legal fees and disbursements) arising out of or relating to your breach of these Terms or your use of the Website, including, but not limited to third-party sites, any use of the Website’s content, services, and products other than as expressly authorized in these Terms.</p>
                ...
                <Row className="mt-5">
                  ...
                  <Col className="col-10">
                    <h4 className="bold">Entire Agreement</h4>
                  </Col>
                </Row>

                <p className="mb-3">The Terms and our Privacy Policy constitute the sole and entire agreement between you and CFT regarding the Website and supersedes all prior and contemporaneous understandings, agreements, representations and warranties, both written and oral, regarding such subject matter.</p>
                ...
                <Row className="mt-5">
                  ...
                  <Col className="col-10">
                    <h4 className="bold">Reporting and Contact</h4>
                  </Col>
                </Row>

                <p className="mb-3">Please send any reports of potential misuse, or any requests or comments relating to the Website, to us at the following email address: <a href="mailto:admin@canadasforesttrust.ca" className="text-orange">admin@canadasforesttrust.ca</a></p>                
              </div>
            </Col>
          </Row>
        </Container>
