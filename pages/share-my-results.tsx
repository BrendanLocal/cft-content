  ...
  return (
    <div className="bg-legacy">
      ...
      <Head>
        ...
        <meta property='og:url' content={'https://' + sharingPrefix + sharingUrl}/>
          ...
          <Col className=" p-3  col-11 col-lg-5 col-xl-4 stickyCalc mb-4">
            <div className="text-white p-5 innerShadow roundedBox bg-green">
              ...
              <div className="mt-3">
                ...
                <FacebookShareButton url={sharingPrefix + sharingUrl} quote={editingdata.shareBusiness} className="mx-2">
                  <FacebookIcon size={40} round />
                </FacebookShareButton>

                <TwitterShareButton url={sharingPrefix + sharingUrl} title={editingdata.shareBusiness} className="mx-2">
