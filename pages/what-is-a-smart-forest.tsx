...
export default function Power({ file }) {
  ...
  const formOptions = {
    ...
    fields: [
      ...
      {name: 'smartForest', component: 'markdown' },
      ...
      {name: 'part1_menu3', component: 'markdown' },
      {name: 'part1_menu4', component: 'markdown' },
      {name: 'part2_header1', component: 'markdown' },
      {name: 'part2_header2', component: 'markdown' },
      {name: 'part2_para1', component: 'markdown' },
      {name: 'part2_box1header1', component: 'markdown' },
      {name: 'part2_box1headerpara1', component: 'markdown' },
      {name: 'part2_box1headerpara2', component: 'markdown' },
      {name: 'part2_box1headerpara3', component: 'markdown' },
      {name: 'part2_box1headerpara4', component: 'markdown' },
      {name: 'part2_box1headerpara5', component: 'markdown' },
      {name: 'part2_box2header1', component: 'markdown' },
      {name: 'part2_box2headerpara1', component: 'markdown' },
      {name: 'part2_box2headerpara2', component: 'markdown' },
      {name: 'part2_box2headerpara3', component: 'markdown' },
      {name: 'part2_box2headerpara4', component: 'markdown' },
      {name: 'part2_box2headerpara5', component: 'markdown' },
      {name: 'part2_box2headerpara6', component: 'markdown' },
      {name: 'part3_header1', component: 'markdown' },
      {name: 'part3_header2', component: 'markdown' },
      {name: 'part3_box1para1', component: 'markdown' },
      {name: 'part3_box1para2', component: 'markdown' },
      {name: 'part3_box1para3', component: 'markdown' },
      {name: 'part4_header1', component: 'markdown' },
      {name: 'part4_box1header1', component: 'markdown' },
      {name: 'part4_box1para1', component: 'markdown' },
      {name: 'part4_box2header1', component: 'markdown' },
      {name: 'part4_box2para1', component: 'markdown' },
      {name: 'part4_box3header1', component: 'markdown' },
      {name: 'part4_box3para1', component: 'markdown' },
      {name: 'part4_box4header1', component: 'markdown' },
      {name: 'part4_box4para1', component: 'markdown' },
      {name: 'part5_header1', component: 'markdown' },
      {name: 'part5_para1', component: 'markdown' },
      {name: 'part5_box1para1', component: 'markdown' },
