            ...
            <div className="card roundedBox no-border bg-white p-4 card-drop cardSpacing">
              ...
              <Row>
                <Col>
                  ...
                  <br />
                  <p>{footprint}</p> <p className="x-small mb-3 op-7">{editingdata.emissionsPlaceholder}</p>
                   </Col>
              </Row>
              <hr/>
              <Row>
...
<div className="mt-3">
                ...
                <FacebookShareButton url={hostname + sharingUrl} quote={editingdata.shareFacebook} hashtag={shareFacebookTags} className="mx-2">
                  <FacebookIcon size={40} round />
                </FacebookShareButton>

                <TwitterShareButton url={hostname + sharingUrl} title={editingdata.shareTwitter} hashtags={editingdata.shareTwitterTags} className="mx-2">
