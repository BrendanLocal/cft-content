    ...
    <Row className="justify-content-center">
      ...
      <div className="card roundedBox no-border bg-white p-4 card-drop cardSpacing">
        ...
        <Row>
          ...
          <input className="mb-4" onChange={changeFootprint} name="type" min="0" oninput="this.value = 
 !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"  type="number" placeholder="Carbon footprint in tonnes per year" />
