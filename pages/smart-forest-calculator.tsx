    ...
    <Row className="justify-content-center">
      ...
      <div className="card roundedBox bg-offwhite p-4 cardShadow cardSpacing">
        ...
        <Row>
          ...
          <input onChange={changeFootprint} name="type" type="number" placeholder="Carbon footprint in tonnes/year" />
...
<option value='100'>100</option>
      ...
      <hr/>
      <Row><Col>You must plant {plantTrees > 0 ? Math.ceil(plantTrees).toLocaleString("en-US") : "--"} trees</Col></Row>
    ...
    <Row className="justify-content-center ">
      ...
      <h3 className="text-white mb-4 px-4">??</h3>
      <Button className="btn-large mt-1" variant="green">??</Button>
      </div>
      </Col>
    </Row>
    ...
    <Row className="justify-content-center mt-5">
      ...
      <h2 className=" text-orange text-center pt-5 bold mb-4 tight-drop-light">Carbon Calculators</h2>
